...
# ╔═╡ a564daf8-3e37-11ec-3b3a-0142ab11ddb0
begin
	using DrWatson
	using Flux, CSV, DataFrames, MLDataPattern, StatsBase, CUDA,StatsPlots, PlotlyJS
end

# ╔═╡ 185b9095-9880-4e81-9148-08a302383cb8
begin
	@show datadir()
	# df = DataFrame(CSV.File("$(datadir())/exp_raw/data.csv";  header=["x","y","z"], types=Float32))
	
	
	# p = Plots.plot3d(;legend=false)
	
	# for i in 4:3:size(df)[2]
	#     Plots.scatter3d!(p, [df[1,i]], [df[1,i+1]], [df[1,i+2]]; markersize=1)
	# end
...
# ╔═╡ f0e94376-3a97-4de1-a7b7-d6a2ecdda4ed
...
[[DrWatson]]
deps = ["Dates", "FileIO", "JLD2", "LibGit2", "MacroTools", "Pkg", "Random", "Requires", "UnPack"]
git-tree-sha1 = "264d6e0ccbacc429605c8dc83827dd785c26ffa0"
